...
const HARDCODED_PLAYERS = [
  { id: 1, name: 'Aleks', joined: true, bg: '#FCF1BA', accent: '#625204' },
  { id: 2, name: 'Tygo', joined: true, bg: '#BAFCEB', accent: '#04624A' },
  { id: 3, name: 'Anya', joined: false, bg: '#BAC5FC', accent: '#041462' },
  { id: 4, name: 'Ian', joined: false, bg: '#E5BAFC', accent: '#410462' },
]
...
export default function LobbyPage() {
  ...
  const handleGenerate = () => {
    navigate('/story', { state: { players, prompts: [{ playerId: 1, text }] } })
  }
      ...
      <div className="lobby__body">
        <div className="lobby__main">
          <div className="lobby__hero">
            ...
            <p className="lobby__tagline">Send the invite link to your friends!</p>
            <div className="lobby__invite-outer">
              <div className="lobby__invite-inner">
                <span className="lobby__invite-code">KNGR-4821</span>
              </div>
            </div>
          </div>
